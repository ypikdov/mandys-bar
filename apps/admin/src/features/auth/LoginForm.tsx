...
const ADMIN_ACCESS_ROLES = ['ADMIN', 'MANAGER', 'VENTAS'];
...
export const LoginForm = ({ onClose }: LoginFormProps) => {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      if (!ADMIN_ACCESS_ROLES.includes(result.user.role)) {
        setAuthError('Esta cuenta no tiene acceso al panel administrativo.');
        return;
      }
